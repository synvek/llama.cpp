...
int llama_server_internal(int argc, char ** argv, bool enable_common_init) {
...
int llama_server(int argc, char ** argv) {
    return llama_server_internal(argc, argv, true);
}
...
extern "C" {
    EXPORT_FUNC int start_llama_server(int argc, char ** argv) {
        ...
        return llama_server_internal(argc, argv, false);
    }
